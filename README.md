...
| Speed | `SPEED,<id>,<val 0-255>` | Set base motor speed |
...
Short clip of NEO-PAC running live: [Pacman_Live.mp4](https://github.com/AbdulAzeemHashmi/Pacman/blob/main/Pacman_Live.mp4)
